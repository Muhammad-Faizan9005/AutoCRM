-- AutoCRM: record-level RLS for customers and organizations.
-- This replaces broad authenticated access with owner/team scoped policies.
...
DROP POLICY IF EXISTS "authenticated_customers_access" ON customers;
DROP POLICY IF EXISTS customer_owner_team_access ON customers;
DROP POLICY IF EXISTS service_role_customers_access ON customers;

DROP POLICY IF EXISTS authenticated_organizations_access ON organizations;
DROP POLICY IF EXISTS "authenticated_organizations_access" ON organizations;
DROP POLICY IF EXISTS organization_owner_team_access ON organizations;
DROP POLICY IF EXISTS service_role_organizations_access ON organizations;
